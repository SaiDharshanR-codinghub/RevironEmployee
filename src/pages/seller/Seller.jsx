  ...
  return (
    <div className="h-screen w-screen bg-gray-50 flex flex-col relative">
      <div className="flex p-4 w-full h-full overflow-hidden">
        ...
        {!showForm && (
          <div className="fixed bottom-6 right-6 flex flex-col items-end gap-4">
            <button
              onClick={toggleForm}
              className="bg-[#73B87C] text-white rounded-full w-14 h-14 text-3xl shadow-lg transition-all duration-300 hover:bg-[#6F9674] transform hover:scale-110 hover:rotate-90"
            >
              +
            </button>
            <button
              onClick={() => alert("Start Selling button clicked!")}
              className="bg-[#73B87C] text-white rounded-lg px-4 py-2 shadow-md hover:bg-[#6F9674] transition-all duration-300 transform hover:scale-105 text-sm font-medium"
            >
              Start Selling
            </button>
          </div>
        ...
        <button
          onClick={() => alert("Start Selling button clicked!")}
          className="bg-white text-green-600 rounded-xl px-6 py-3 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 font-semibold border-2 border-green-600 hover:bg-green-600 hover:text-white"
        >
          Start Selling
        </button>
      </div>
      ...
      <style jsx>{`
        ...
        .filter-red {
          filter: invert(16%) sepia(97%) saturate(6380%) hue-rotate(356deg)
